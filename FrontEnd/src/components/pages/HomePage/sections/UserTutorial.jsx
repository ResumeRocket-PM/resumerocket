    ...
    return (
        <div>
            <div>
                ...
                <img src="./images/createAccount.mov" alt="Create Account" />
                ...
                <img src="./images/accountSetup.mov" alt="Account Setup" />
                <p>
                ...
                <img src="./images/createProject.mov" alt="Project Setup" />
                <p>
                ...
                <img src="./images/projectSections.png" alt="Project Sections" />
                ...
                <img src="./images/resumeRepository.png" alt="Resume Repository" />
                ...
                <img src="./images/versionHistory.mov" alt="Video Link for Version History" />
                ...
                <img src="./images/createApplication.png" alt="Application Creation" />
                <p>
                ...
                <img src="./images/applicationResume.png" alt="View Resume" />
                <p>
                ...
                <img src="./images/suggestions.png" alt="Suggested Changes" />
                <p>
                ...
                <img src="./images/resumeAssistant.png" alt="Resume Assistant" />
                ...
                <img src="./images/createApplicationExtension.png" alt="Extension Application" />
                <p>
                ...
                <img src="./images/extensionAccountView.png" alt="Extension Account View" />
                ...
                <img src="./images/userSearch.png" alt="User Search" />
                <p>
                ...
                <img src="./images/viewAccountItems.png" alt="View Account Items" />
                <p>
                ...
                <img src="./images/userChat.png" alt="User Chat" />
            </div>
        </div>
    );
};
